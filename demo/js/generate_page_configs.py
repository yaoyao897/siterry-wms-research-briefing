...
PAGES = [
    ...
    ("mat-medium", "物料介质对照表", ["基础数据", "基础资料"], "01-基础数据/01-基础资料/03-物料介质对照表"),
    ("customer", "客户列表", ["基础数据", "基础资料"], "01-基础数据/01-基础资料/04-客户列表"),
    ("supplier", "供应商列表", ["基础数据", "基础资料"], "01-基础数据/01-基础资料/05-供应商列表"),
    ("unit", "单位列表", ["基础数据", "基础资料"], "01-基础数据/01-基础资料/06-单位列表"),
    ("dict", "数据字典", ["基础数据", "基础资料"], "01-基础数据/01-基础资料/07-数据字典"),
    ("carrier", "承运商列表", ["基础数据", "物流资料"], "01-基础数据/02-物流资料/01-承运商列表"),
    ("vehicle", "车辆列表", ["基础数据", "物流资料"], "01-基础数据/02-物流资料/02-车辆列表"),
    ("driver", "司机列表", ["基础数据", "物流资料"], "01-基础数据/02-物流资料/03-司机列表"),
    ("freight", "运费参照表", ["基础数据", "物流资料"], "01-基础数据/02-物流资料/04-运费参照表"),
    ("warehouse", "仓库列表", ["基础数据", "仓储资料"], "01-基础数据/03-仓储资料/01-仓库列表"),
    ("stock-warn", "库存预警", ["基础数据", "仓储资料"], "01-基础数据/03-仓储资料/02-库存预警"),
    ("insp-proc", "检查工序", ["基础数据", "仓储资料"], "01-基础数据/03-仓储资料/03-检查工序"),
    ("insp-craft", "检查工艺", ["基础数据", "仓储资料"], "01-基础数据/03-仓储资料/04-检查工艺"),
    ("po", "采购订单", ["基础数据", "订单资料"], "01-基础数据/05-订单资料/01-采购订单"),
    ("so", "销售订单", ["基础数据", "订单资料"], "01-基础数据/05-订单资料/02-销售订单"),
    ("serial-arch", "流水码档案", ["基础数据", "包材资料"], "01-基础数据/06-包材资料/01-流水码档案"),
    ("tank-arch", "储罐档案", ["基础数据", "包材资料", "固定包材档案"], "01-基础数据/06-包材资料/02-固定包材档案/01-储罐档案"),
    ("app-view-cfg", "APP信息查看配置", ["基础数据", "包材资料"], "01-基础数据/06-包材资料/03-APP信息查看配置"),
    ("pkg-proc", "包材工序", ["基础数据", "包材资料"], "01-基础数据/06-包材资料/04-包材工序"),
    ("pkg-craft", "包材工艺", ["基础数据", "包材资料"], "01-基础数据/06-包材资料/05-包材工艺"),
    ("outer-serial", "流水外包材档案", ["基础数据", "外包材资料"], "01-基础数据/07-外包材资料/01-流水外包材档案"),
    ("outer-fixed", "固定外包材档案", ["基础数据", "外包材资料"], "01-基础数据/07-外包材资料/02-固定外包材档案"),
    ("label-ds", "标签数据源", ["基础数据", "标签配置"], "01-基础数据/08-标签配置/01-标签数据源"),
    ("label-cfg", "标签配置", ["基础数据", "标签配置"], "01-基础数据/08-标签配置/02-标签配置"),
    ("print-task", "打印任务", ["基础数据", "标签配置"], "01-基础数据/08-标签配置/03-打印任务"),
    ("form-ds", "表单数据源", ["基础数据", "表单配置"], "01-基础数据/09-表单配置/01-表单数据源"),
    ("form-designer", "表单设计器", ["基础数据", "表单配置"], "01-基础数据/09-表单配置/02-表单设计器"),
    # 物流管理
    ("wh-po-in", "采购入库", ["仓储管理", "采购"], "03-仓储管理/01-采购/01-采购入库"),
    ("wh-po-ret", "采购退料", ["仓储管理", "采购"], "03-仓储管理/01-采购/02-采购退料"),
    ("wh-os-issue", "委外发料", ["仓储管理", "委外"], "03-仓储管理/02-委外/01-委外发料"),
    ("wh-os-ret-mat", "委外退料", ["仓储管理", "委外"], "03-仓储管理/02-委外/02-委外退料"),
    ("wh-os-recv", "委外收货", ["仓储管理", "委外"], "03-仓储管理/02-委外/03-委外收货"),
    ("wh-os-ret-goods", "委外退货", ["仓储管理", "委外"], "03-仓储管理/02-委外/04-委外退货"),
    ("wh-prod-issue", "生产领料", ["仓储管理", "生产"], "03-仓储管理/03-生产/01-生产领料"),
    ("wh-prod-ret", "生产退料", ["仓储管理", "生产"], "03-仓储管理/03-生产/02-生产退料"),
    ("wh-prod-in", "生产入库", ["仓储管理", "生产"], "03-仓储管理/03-生产/03-生产入库"),
    ("wh-cs-recv", "受托收料", ["仓储管理", "受托"], "03-仓储管理/04-受托/01-受托收料"),
    ("wh-cs-ret", "受托退料", ["仓储管理", "受托"], "03-仓储管理/04-受托/02-受托退料"),
    ("wh-so-prep", "备货通知", ["仓储管理", "销售"], "03-仓储管理/05-销售/01-备货通知"),
    ("wh-so-preout", "销售预出货", ["仓储管理", "销售"], "03-仓储管理/05-销售/04-销售预出货"),
    ("wh-so-ship", "销售发货", ["仓储管理", "销售"], "03-仓储管理/05-销售/02-销售发货"),
    ("wh-so-ret", "销售退货", ["仓储管理", "销售"], "03-仓储管理/05-销售/03-销售退货"),
    ("wh-direct-xfer", "直接调拨", ["仓储管理", "调拨"], "03-仓储管理/06-调拨/01-直接调拨"),
    ("wh-other-in", "其他入库", ["仓储管理", "其他"], "03-仓储管理/07-其他/01-其他入库"),
    ("wh-other-out", "其他出库", ["仓储管理", "其他"], "03-仓储管理/07-其他/02-其他出库"),
    ("wh-load", "装卸货", ["仓储管理", "装卸"], "03-仓储管理/08-装卸/01-装卸货"),
    ("wh-transfer", "库内转移", ["仓储管理", "库内"], "03-仓储管理/09-库内/01-库内转移"),
    ("wh-seq", "库内转序", ["仓储管理", "库内"], "03-仓储管理/09-库内/02-库内转序"),
    ("wh-stocktake", "库存全盘", ["仓储管理", "盘点"], "03-仓储管理/10-盘点/01-库存全盘"),
    ("wh-inv-rpt", "仓库库存", ["仓储管理", "报表统计"], "03-仓储管理/12-报表统计/01-仓库库存"),
]
