...
window.APP_CFG = (function () {
  ...
  const flowMeta = {
    ...
    'po-in-tank': flow('采购入库-罐区', 'tank', { refLabel: '关联采购订单', execVariant: 'tank-in', addMatTitle: '添加厂外物料' }),
    ...
    'prod-pick-tank': flow('生产领料-罐区', 'tank', { isOut: true, docKind: 'dept', partnerLabel: '生产部门', refLabel: '关联生产订单', execVariant: 'tank-pick' }),
    ...
    'prod-ret-tank': flow('生产退料-罐区', 'tank', { docKind: 'dept', partnerLabel: '生产部门', refLabel: '关联生产订单', execVariant: 'tank-ret', qtyLabel: '退料数量' }),
    ...
    'os-recv-tank': flow('委外收货-罐区', 'tank', { partnerLabel: '供应商名称', refLabel: '关联委外加工单', execVariant: 'tank-in', addMatTitle: '添加厂外物料', extraInfoLabel: '委外商' }),
