  ...
  const waybills = [
    {
      ...
      plate: '川A12345',
      phone: '138****1234',
      planLoad: '2025-08-07 08:00',
      scheduleAt: '2025-08-06 09:00',
      route: '成都A区 → 绵阳B区',
      loads: [
        {
          id: 'TH202508070001',
          type: 'load',
          status: '待确认',
          shipNo: 'FH20250801001',
          unit: '四川思特瑞科技',
          place: '成都高新区A区3号库',
          contact: '赵主管 / 138****0001',
          material: 'A001 钢瓶 / φ219 / 成品',
          qty: '500 Kg',
          lines: [
            { code: 'A001', name: '钢瓶', spec: 'φ219', kind: '成品', planQty: 500, unit: 'Kg', actualQty: 500, remark: '', confirmed: false },
            { code: 'B002', name: '铝瓶', spec: 'φ165', kind: '半成品', planQty: 300, unit: '件', actualQty: 300, remark: '', confirmed: false },
          ],
          procs: [
            { name: '装货确认', status: '已完成', user: '张司', time: '08:30' },
        ...
        },
        {
          ...
          type: 'load',
          status: '待确认',
          shipNo: 'FH20250801002',
          unit: '四川思特瑞科技',
          place: '成都高新区B区1号库',
          contact: '钱主管 / 138****0002',
          material: 'C003 阀门 / DN25 / 配件',
          qty: '200 套',
          lines: [
            { code: 'C003', name: '阀门', spec: 'DN25', kind: '配件', planQty: 200, unit: '套', actualQty: 200, remark: '', confirmed: false },
          ],
          procs: [
      ...
      unloads: [
        {
          ...
          type: 'unload',
          status: '待确认',
          recvNo: 'SH20250801001',
          unit: '绵阳客户A',
          place: '绵阳经开区B区2号库',
          contact: '孙仓管 / 139****0003',
          material: 'A001 钢瓶 / φ219 / 成品',
          qty: '500 Kg',
          lines: [
            { code: 'A001', name: '钢瓶', spec: 'φ219', kind: '成品', planQty: 500, unit: 'Kg', actualQty: 500, remark: '', confirmed: false },
          ...
          procs: [
            ...
            { name: '外观检查', status: '待执行', user: '—', time: '—' },
          ],
        },
      ],
    ...
    },
    {
      ...
      plate: '川B67890',
      phone: '137****5678',
      planLoad: '2025-08-08 06:00',
      scheduleAt: '2025-08-07 10:00',
      route: '德阳C区 → 成都D区',
      loads: [
        {
          id: 'TH202508080001',
          type: 'load',
          status: '已确认',
          shipNo: 'FH20250802001',
          unit: '德阳发货仓',
          place: '德阳C区3号库',
          contact: '周主管 / 136****1111',
          material: 'D001 成品气 / 原料',
          qty: '1000 Kg',
          lines: [
            { code: 'D001', name: '成品气', spec: '标准', kind: '原料', planQty: 1000, unit: 'Kg', actualQty: 1000, remark: '', confirmed: true },
          ],
          procs: [
            { name: '装货确认', status: '已完成', user: '王司', time: '06:20' },
          ],
        },
      ],
      unloads: [
        {
          ...
          type: 'unload',
          status: '待确认',
          recvNo: 'SH20250802001',
          unit: '成都客户B',
          place: '成都D区5号库',
          contact: '吴仓管 / 135****2222',
          material: 'D001 成品气 / 原料',
          qty: '1000 Kg',
          lines: [
            { code: 'D001', name: '成品气', spec: '标准', kind: '原料', planQty: 1000, unit: 'Kg', actualQty: 980, remark: '', confirmed: false },
          ],
          procs: [
            { name: '卸货确认', status: '待执行', user: '—', time: '—' },
          ],
      ...
      enroute: { location: '成绵高速', remark: '预计14:00到达', updatedAt: '2025-08-08 11:30' },
    },
  ];
